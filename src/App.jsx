...
function App() {
      ...
      values: [
        {
          name: "Home",
          url: "#",
          func: () => scrollToSection(homeRef)
        },
        {
          name: "Experiance",
          url: "#",
          func: () => scrollToSection(experienceRef)
        },
        {
          name: "Projects",
          url: "#",
          func: () => scrollToSection(projectRef)
        },
        {
          name: "Skills",
          url: "#",
          func: () => scrollToSection(skillsRef)

        },
        {
          name: "Contact Me",
          url: "#",
          func: () => scrollToSection(contactRef)
        },
      ],
    },

    {
      ...
      values: [
        ...
        },
        {
          ...
          url: "https://www.linkedin.com/in/sagar-dhone-817b2a190/",
        },
        {
          name: "Twitter",
          svgCode: (
          ...
          url: "https://twitter.com/sdhone98",
        },
      ],
    },
    {
  ...
  return (
    <div className={darkModeOn ? "dark-mode" : "light-mode"}>
      ...
      />
      <div ref={homeRef}>
        <Home isDarkModeOn={darkModeOn} contactRef={contactRef}/>
      </div>
